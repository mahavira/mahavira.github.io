(function () {
    ...
    var stageDom = document.getElementById((window._mrmcp || {})['script_id'] || "Mugeda_58c5fb0acb5963d2008b4b3a")

    _mrmcp = (typeof _mrmcp == 'undefined') ? {} : _mrmcp;
_mrmcp['campaign_id'] = 'none';
_mrmcp['owner_id'] = '575f681408af60fd008b4583';
_mrmcp['creative_id'] = '58c5fb0acb5963d2008b4b3a';
...
Mugeda.Loader.prototype.start = function () {
    if (2 == Mugeda.css3PlayerLoaded) {
        ...
        Mugeda['startAnimation']("id_" + this.crid, true ? "actions_" + this.crid + ".js" : "", a, this.resDir, this.name, null, this._mrmcp)
    }
    else {
